...
function addToRemoveQueue(toastId: string, dispatch: React.Dispatch<any>) {
...
function toast(props: Omit<ToasterToast, "id">) {
  ...
  dispatch({ type: actionTypes.ADD_TOAST, toast: { ...props, id, open: true, onOpenChange: (o: boolean) => { if (!o) dismiss(); } } });
  return { id, dismiss };
}
